...
# creating  a dictionary  to referrence colours  for each three classes 
cd = {0:'r',1:'b',2:"g"}

# creating array of colours so that the 3 classes are plotted in different colours.
cols = np.array([cd[target] for target in targets])

# ploting the scatter plots in their axes
